...
const EGUI_FNS: EguiFnMap = AUTOGENERATED_EGUI_FNS
    ...
    .with(EguiFn::egui_context_Context_inspection_ui, |ctx: EguiPointer<Context>, mut ui: EguiPointer<Ui>| unsafe { ctx.get().inspection_ui(ui.get_mut()) })
    .with(EguiFn::egui_context_Context_loaders_ui, |ctx: EguiPointer<Context>, mut ui: EguiPointer<Ui>| unsafe { ctx.get().loaders_ui(ui.get_mut()) })
    .with(EguiFn::egui_context_Context_memory_ui, |ctx: EguiPointer<Context>, mut ui: EguiPointer<Ui>| unsafe { ctx.get().memory_ui(ui.get_mut()) })
    .with(EguiFn::egui_context_Context_settings_ui, |ctx: EguiPointer<Context>, mut ui: EguiPointer<Ui>| unsafe { ctx.get().settings_ui(ui.get_mut()) })
    .with(EguiFn::egui_context_Context_style_ui, |ctx: EguiPointer<Context>, mut ui: EguiPointer<Ui>, theme: Theme| unsafe { ctx.get().style_ui(ui.get_mut(), theme) })
    .with(EguiFn::egui_context_Context_texture_ui, |ctx: EguiPointer<Context>, mut ui: EguiPointer<Ui>| unsafe { ctx.get().texture_ui(ui.get_mut()) })
